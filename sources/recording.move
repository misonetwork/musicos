...
public fun new_reward_pool<RecordingShare, Currency>(self: &mut Recording<RecordingShare>): RewardPool<RecordingShare, Currency> {
    reward_pool::new<RecordingShare, Currency>(&mut self.id)
}
