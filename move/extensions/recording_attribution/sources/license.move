...
public struct LicenseAttachedEvent has copy, drop {
    recording_id: ID,
    scopes: VecSet<String>,
}

public struct LicenseRevokedEvent has copy, drop {
    recording_id: ID,
}
...
public fun attach<RecordingShare, CompositionShare>(
    ...
    emit(LicenseAttachedEvent { recording_id, scopes });
...
public fun revoke<RecordingShare, CompositionShare>(
    ...
    emit(LicenseRevokedEvent { recording_id });
}
