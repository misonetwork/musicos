...
#[test, expected_failure(abort_code = EMaxDiscsExceeded, location = miso::release)]
...
#[test, expected_failure(abort_code = EMaxSubtitleLengthExceeded, location = miso::release)]
...
#[test, expected_failure(abort_code = ENoDiscs, location = miso::release)]
