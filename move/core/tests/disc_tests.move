...
#[test, expected_failure(abort_code = EMaxTracksExceeded, location = miso::disc)]
...
#[test, expected_failure(abort_code = EEmptyString, location = miso::disc)]
...
#[test, expected_failure(abort_code = EMaxTitleLengthExceeded, location = miso::disc)]
